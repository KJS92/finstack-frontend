...
}> = ({ label, value, onClick, disabled, danger, children }) => (
  <div style={{
  ...
  >
    <div>
      <p style={{
        ...
        color: danger ? '#E11D48' : theme.colors.textPrimary,
      }}>
        {label}
      </p>
      {value && (
        <p style={{ margin: '2px 0 0', fontSize: theme.fontSizes.label, color: theme.colors.textMuted }}>
          {value}
        </p>
      )}
      {children}
    ...
    {onClick && !disabled && (
      <ChevronRight size={16} color={danger ? '#E11D48' : theme.colors.textMuted} />
    )}
  </div>
);
      ...
      <div style={{ padding: '20px 16px 80px', maxWidth: '640px', margin: '0 auto' }}>
        ...
        {feedback && (
          <div style={{
            ...
            fontWeight: theme.fontWeights.medium,
            background: feedback.type === 'success' ? '#DCFCE7' : '#FFF1F2',
            color: feedback.type === 'success' ? '#15803D' : '#E11D48',
          ...
          {showPasswordForm && (
            <form onSubmit={handlePasswordChange} style={{
              ...
              {[{ label: 'New Password', val: newPassword, set: setNewPassword },
                { label: 'Confirm Password', val: confirmPassword, set: setConfirmPassword }].map(f => (
                <div key={f.label}>
                  <label style={{ display: 'block', fontSize: theme.fontSizes.caption, fontWeight: theme.fontWeights.semibold, color: theme.colors.textSecondary, marginBottom: '5px' }}>
                    {f.label}
                  </label>
                  <input
                    type="password"
